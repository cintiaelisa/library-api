...
public interface LoanRepository extends JpaRepository<Loan, Long> {
    ...
    @Query( value = "select l from Loan l where l.loanDate <= :treeDaysAgo and ( l.returned is null or l.returned is false )" )
    List<Loan> findByLoanDateLessThanAndNotReturned( @Param("treeDaysAgo") LocalDate threeDaysAgo);
}
